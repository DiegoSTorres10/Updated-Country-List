...
## Overview
Updated Country List is a Python program designed to read a CSV file containing a list of countries and extract their names along with their three-letter abbreviations. This project provides a simple and efficient way to access an up-to-date country list with essential information.
...
```
git clone https://github.com/DiegoSTorres10/Updated-Country-List.git
cd Updated-Country-List
python LeerCSV.py
```
...
The script will prompt you to input the path to the CSV file containing the list of countries.

View Output:

Once the script completes, it will generate an output file with the extracted country names and abbreviations.
Example 
```
Afganistán: AFG
Albania: ALB
